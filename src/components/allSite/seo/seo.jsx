  ...
  const { site, siteLogo, defaultFb } = useStaticQuery(
    graphql`
      query {
        ...
        siteLogo: file(relativePath: { eq: "at-dawn-wellness.png" }) {
          publicURL
        }

        defaultFb: file(relativePath: { eq: "at-dawn-wellness-default.png" }) {
          publicURL
        }
      }
    `
  ...
  return (
    <React.Fragment>
      ...
      <SchemaOrg
        ...
        canonicalUrl="https://atdawnwellness.ca/"
        author=""
        organization="At Dawn Wellness"
        defaultTitle="At Dawn Wellness"
      />
    </React.Fragment>
  )
}
